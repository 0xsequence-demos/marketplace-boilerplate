...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      'text-sm outline-none transition-colors focus:bg-foreground/10 focus:text-foreground',
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ...
    {...props}
  >
    <span className="absolute left-2 flex h-4 w-4 items-center justify-center rounded-sm border border-primary">
      <DropdownMenuPrimitive.ItemIndicator className="h-4 w-4 rounded-sm data-[state=checked]:bg-primary">
...
>(({ className, children, ...props }, ref) => (
  <DropdownMenuPrimitive.RadioItem
    ...
    className={cn(
      ...
      'data-[state="checked"]:bg-foreground/20',
      className,
    )}
    {...props}
  >
